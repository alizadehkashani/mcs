...
let buildgeneratestartgroups = () => {
	...
	let day2button = creatediv({
		divclass: ["importcsvbutton"],
		appendto: generategroupsbuttonscontainer,
		divtext: "Tag 2"
	})

	day2button.addEventListener("click", async () =>{
	...
	let day3button = creatediv({
		divclass: ["importcsvbutton"],
		appendto: generategroupsbuttonscontainer,
		divtext: "Tag 3"
	})

	day3button.addEventListener("click", async () =>{
