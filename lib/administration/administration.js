...
function buildStartgroups(){
	...
	buildgroupcontrol(startgroupscontentdiv, "trackacontrolcontainer");
	buildgroupcontrol(startgroupscontentdiv, "trackbcontrolcontainer");

	buildtrackplayers(startgroupscontentdiv, "trackaplayercontainer");
	buildtrackplayers(startgroupscontentdiv, "trackbplayercontainer");
...
function buildtrackplayers(contentdiv, playercontainerdivid){
...
function buildgroupcontrol(contendiv, containerid){
		...
		trackcurrentgroupcontainer.innerText = "1";
